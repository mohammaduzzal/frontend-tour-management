...
export default function AddTour() {
  ...
  const handleSubmit = async (data : z.infer<typeof formSchema>) => {
    ...
    const tourData = {
      ...
      excluded: data.excluded[0].value === "" ? [] : data.excluded.map((item: { value: string }) => item.value),
            ...
            >
              ...
              <div>
                <div className="flex justify-between">
                  <p>Included</p>
                  <Button variant="outline" size="icon" type="button" onClick={() => append({ value: "" })}><Plus /></Button>
                </div>
                <div className="space-y-5 mt-4">
                  {
                    fields.map((item, index) => (
                      <div className="flex gap-2">
                        ...
                        />
                        <Button onClick={() => remove(index)} type="button" size="icon" variant="destructive"><Trash2 /></Button>
                      </div>
                    ))
                  }
                </div>
              ...
              <div>
                <div className="flex justify-between">
                  <p>excluded</p>
                  <Button variant="outline" size="icon" type="button" onClick={() => excludedAppend({ value: "" })}><Plus /></Button>
                </div>
                <div className="space-y-5 mt-4">
                  {
                    excludedFields.map((item, index) => (
                      <div className="flex gap-2">
                        ...
                        />
                        <Button onClick={() => excludedRemove(index)} type="button" size="icon" variant="destructive"><Trash2 /></Button>
                      </div>
                    ))
                  }
                </div>
              ...
              <div>
                <div className="flex justify-between">
                  <p>amenities</p>
                  <Button variant="outline" size="icon" type="button" onClick={() => amenitiesAppend({ value: "" })}><Plus /></Button>
                </div>
                <div className="space-y-5 mt-4">
                  {
                    amenitiesFields.map((item, index) => (
                      <div className="flex gap-2">
                        ...
                        />
                        <Button onClick={() => amenitiesRemove(index)} type="button" size="icon" variant="destructive"><Trash2 /></Button>
                      </div>
                    ))
                  }
                </div>
              ...
              <div>
                <div className="flex justify-between">
                  <p>tourPlan</p>
                  <Button variant="outline" size="icon" type="button" onClick={() => tourPlanAppend({ value: "" })}><Plus /></Button>
                </div>
                <div className="space-y-5 mt-4">
                  {
                    tourPlanFields.map((item, index) => (
                      <div className="flex gap-2">
                        ...
                        />
                        <Button onClick={() => tourPlanRemove(index)} type="button" size="icon" variant="destructive"><Trash2 /></Button>
                      </div>
                    ))
                  }
                </div>
